...
float pi = 3.14;
float kilometersPerHour=0,metersPerSecond=0;
...
//Creating dht object from DHT class
...
void loop() {
  ...
  rev=0;
  attachInterrupt(0,isr,RISING);
  float metersPerSecond=(2*pi*wheelradius*rpm)/60;
  ...
  display.print(kilometersPerHour);
  ...
  //To calculate battery voltage levels
  ...
  float distance=kilometersPerHour*(time/60000);
  display.setTextSize(1);
  display.setCursor(80,0);
  display.print("Distance");
  display.setTextSize(1);
  display.setCursor(80,10);
  display.print("Covered=");
  display.setTextSize(1);
  display.setCursor(80,20);
  display.print(distance);

  //To calculate charge left 
  float charge=100.00;
  display.setTextSize(1);
